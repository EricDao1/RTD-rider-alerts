...
class RiderAlertServiceTest {
    ...
    @Test
    fun testService() {
        val alertService = RiderAlertService()
        Truth.assertThat((alertService.LocalBinder().getService())).isInstanceOf(RiderAlertService::class.java)
    }
